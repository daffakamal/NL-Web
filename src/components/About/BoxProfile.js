const BoxProfile = ({title, name}) => {
    return (
      <div className="w-fit flex flex-col justify-center my-6 mx-12 xl:mx-16">
        ...
        <p className="font-poppinsSemi mt-8 text-white text-[18px] md:text-xl lg:text-2xl">
          {title}
        </p>
        <p className="font-poppinsRegular my-2 text-white text-[16px] md:text-[18px] lg:text-xl">
          {name}
        </p>
      </div>
    );
