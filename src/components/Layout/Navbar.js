...
const Navbar = () => {
    ...
    return (
      <nav className="w-full bg-red-NL shadow-2xl fixed z-40 px-7 smallest:px-12 sm:px-14 md:px-20 lg:px-24 xl:px-[134px]">
        <div className="w-full flex mx-auto container h-12 sm:h-14 md:h-16 2xl:h-[68px] 2xl:max-w-[1400px]">
                        ...
                        <Menu.Item>
                          {({ active }) => (
                            <a
                              ...
                              className={`${
                                active
                                  ? "grid bg-pink-NL text-white"
                                  : "grid bg-white-NL text-black"
                          ...
                          <Menu.Item>
                            {({ active }) => (
                              <a
                                ...
                                className={`${
                                  active
                                    ? "flex bg-pink-NL text-white"
                                    : "flex bg-white-NL text-black"
                                } group flex w-full items-center rounded-md px-4 py-1.5`}
                              >
                                {link.title}
                              </a>
